...
#
# usage: ./ec2_installation.sh start (spin up EC2 and create the tunnel)
#        ./ec2_installation.sh stop (terminate the EC2 instance to save money)
#        ./ec2_installation.sh resume (in case your tunnel is interrupted but the EC2 instance is still running)

# CHANGE THE PARAMETERS BELOW

imageid="ami-43a15f3e" # this is an Ubuntu AMI, but you can change it to whatever you want
instance_type="t2.micro"
key_name="ansible-test" # your keypair name -- http://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2-key-pairs.html
security_group="default" # your security group -- http://docs.aws.amazon.com/AWSEC2/latest/UserGuide/using-network-security.html
...
key_location="/home/ubuntu/ansible-test.pem" # your private key -- http://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2-key-pairs.html#having-ec2-create-your-key-pair
